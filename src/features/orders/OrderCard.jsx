...
function OrderCard({ order }) {
  ...
  return (
    <div className="rounded-md border-[0.1rem] border-r-gray-200 dark:border-gray-700 dark:shadow-md">
      ...
      <div className="space-y-10 rounded-b-md bg-white px-10 py-7 dark:bg-gray-800">
        <div className="flex flex-wrap items-center gap-4">
          <p className="flex items-center gap-2 rounded-2xl bg-gray-100 px-3 py-1 dark:bg-gray-900">
            <span>
        ...
        <div className="space-y-2">
          {order_items?.map((order_item, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              {order_item?.products?.discount > 0 && (
                <>
                  <span>-</span>
